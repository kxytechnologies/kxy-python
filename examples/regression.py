...
if __name__ == '__main__':
	...
	logging.info('Additive Suboptimality: %.4f' % test_df.regression_additive_suboptimality('Prediction', label_column))
	logging.info('Suboptimality: %.4f' % test_df.regression_suboptimality('Prediction', label_column))
